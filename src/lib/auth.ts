...
const TOKEN_PROXY_URL = 'https://githatch-token-proxy.lukemaxwellshouse.workers.dev/token'
...
export async function exchangeCodeForToken(
  ...
  // Token exchange goes via a thin CORS proxy — GitHub's token endpoint blocks
  // browser requests. The proxy forwards to GitHub; no client_secret is stored
  // there (GitHub App + PKCE doesn't require one).
